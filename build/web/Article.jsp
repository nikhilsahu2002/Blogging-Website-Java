...
<center><h1 style="margin-top:20px;">Article Form</h1></center>>
      <form action="ArticleServlet" method="post" enctype="multipart/form-data" style="margin-top : 20px">
        <label for="name">User Name:</label>
        <input type="text" id="name" name="name" required><br><br>
        <label for="class">Your Post Number:</label>
        <input type="text" id="class" name="class" required><br><br>
        <label for="class">Headline:</label>
        <input type="text" id="class" name="headline" required><br><br>
        <label for="class">Description:</label>
        <textarea id="id_description" name="description" required></textarea><br><br>
        <label for="class">Date:</label>
        <input type="date" name="date" required><br><br>
        
        <label for="class">Portrait Photo:</label>
