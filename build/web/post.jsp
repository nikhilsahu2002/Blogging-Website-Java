  ...
  <!-- Container wrapper -->
    ...
    <div class="containers">
        ...
        <div style="text-align: center; margin-top: 20px;">
            ...
            <% if (base64Image != null) { %>
                <img src="data:image/jpeg;base64,<%= base64Image %>" alt="Article Image" style="width: 400px; height: 300px; border: 1px solid black; margin-top: 10px; border-radius: 5px;">
            <% } %>
            <h1 style="margin-top: 10px;"><a href="dynamic_page.jsp?headline=<%= headline %>"><%= headline %></a></h1>
            <p><%= description %></p>
        </div>
        <%
            }
